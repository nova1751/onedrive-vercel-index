...
module.exports = {
  ...
  googleFontSans: 'ZCOOL KuaiLe',
  // googleFontMono - the monospace font used in onedrive-vercel-index.
  googleFontMono: 'Inter',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Inter&family=ZCOOL+KuaiLe:wght@400;500;700&display=swap'],
